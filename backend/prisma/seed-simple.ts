...
async function main() {
  ...
  const products = [
    { name: 'Coca-Cola 330ml', category: 'Beverages', unitPrice: 15.99, sku: 'CC-330' },
    { name: 'Pepsi 330ml', category: 'Beverages', unitPrice: 14.99, sku: 'PP-330' },
    { name: 'Lays Chips Original', category: 'Snacks', unitPrice: 12.99, sku: 'LC-ORG' },
    { name: 'Simba Chips', category: 'Snacks', unitPrice: 11.99, sku: 'SC-REG' },
    { name: 'Bread Loaf', category: 'Bakery', unitPrice: 18.99, sku: 'BR-WHT' }
  ];
